...
class KArrayStoreDecl<D : KSort, R : KSort> internal constructor(ctx: KContext, sort: KArraySort<D, R>) :
...
class KArraySelectDecl<D : KSort, R : KSort> internal constructor(ctx: KContext, sort: KArraySort<D, R>) :
...
class KArrayConstDecl<D : KSort, R : KSort>(ctx: KContext, sort: KArraySort<D, R>) :

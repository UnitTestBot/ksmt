...
object KIntModDecl : KFuncDecl2<KIntSort, KIntSort, KIntSort>("intMod", KIntSort, KIntSort, KIntSort) {
    override fun apply(arg0: KExpr<KIntSort>, arg1: KExpr<KIntSort>): KApp<KIntSort, *> = mkIntMod(arg0, arg1)
    override fun <R> accept(visitor: KDeclVisitor<R>): R = visitor.visit(this)
}

object KIntRemDecl : KFuncDecl2<KIntSort, KIntSort, KIntSort>("intRem", KIntSort, KIntSort, KIntSort) {
    override fun apply(arg0: KExpr<KIntSort>, arg1: KExpr<KIntSort>): KApp<KIntSort, *> = mkIntRem(arg0, arg1)
    override fun <R> accept(visitor: KDeclVisitor<R>): R = visitor.visit(this)
}

object KIntToRealDecl : KFuncDecl1<KRealSort, KIntSort>("intToReal", KRealSort, KIntSort) {
    override fun apply(arg: KExpr<KIntSort>): KApp<KRealSort, KExpr<KIntSort>> = mkIntToReal(arg)
    override fun <R> accept(visitor: KDeclVisitor<R>): R = visitor.visit(this)
}

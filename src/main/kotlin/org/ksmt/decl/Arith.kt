...
class KArithAddDecl<T : KArithSort<T>>(ctx: KContext, argumentSort: T) :
...
class KArithMulDecl<T : KArithSort<T>>(ctx: KContext, argumentSort: T) :
...
class KArithSubDecl<T : KArithSort<T>>(ctx: KContext, argumentSort: T) :
...
class KArithUnaryMinusDecl<T : KArithSort<T>>(ctx: KContext, argumentSort: T) :
...
class KArithDivDecl<T : KArithSort<T>>(ctx: KContext, argumentSort: T) :
...
class KArithPowerDecl<T : KArithSort<T>>(ctx: KContext, argumentSort: T) :
...
class KArithLtDecl<T : KArithSort<T>>(ctx: KContext, argumentSort: T) :
...
class KArithLeDecl<T : KArithSort<T>>(ctx: KContext, argumentSort: T) :
...
class KArithGtDecl<T : KArithSort<T>>(ctx: KContext, argumentSort: T) :
...
class KArithGeDecl<T : KArithSort<T>>(ctx: KContext, argumentSort: T) :

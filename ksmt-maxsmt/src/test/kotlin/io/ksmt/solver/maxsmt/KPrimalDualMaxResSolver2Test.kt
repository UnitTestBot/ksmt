...
class KPrimalDualMaxResSolver2Test : KMaxSMTSolverTest() {
    override fun getSolver(): KMaxSMTSolver<KZ3SolverConfiguration> = with(ctx) {
        val z3Solver = KZ3Solver(this)
        return KPrimalDualMaxResSolver(this, z3Solver, KMaxSMTContext(preferLargeWeightConstraintsForCores = false))
    }
}

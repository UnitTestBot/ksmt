...
class KRealToIntDecl internal constructor(
    ...
    override fun KContext.apply(arg: KExpr<KRealSort>): KApp<KIntSort, KRealSort> = mkRealToInt(arg)
...
class KRealIsIntDecl internal constructor(
    ...
    override fun KContext.apply(arg: KExpr<KRealSort>): KApp<KBoolSort, KRealSort> = mkRealIsInt(arg)

...
interface KTransformer {
    ...
    fun transform(expr: KBvRotateLeftIndexedExpr): KExpr<KBvSort> = transformApp(expr)
    fun transform(expr: KBvRotateRightExpr): KExpr<KBvSort> = transformApp(expr)
    fun transform(expr: KBvRotateRightIndexedExpr): KExpr<KBvSort> = transformApp(expr)

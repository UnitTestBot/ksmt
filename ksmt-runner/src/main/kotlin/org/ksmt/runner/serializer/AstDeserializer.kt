...
class AstDeserializer(
    ...
    private fun AbstractBuffer.deserializeExpr(kind: ExprKind): KExpr<*> = with(serializationCtx.ctx) {
        when (kind) {
            ...
            ExprKind.UnaryMinusArithExpr -> deserialize<KArithSort<*>, KArithSort<*>>(::mkArithUnaryMinus)
            ExprKind.DivArithExpr -> deserialize<KArithSort<*>, KArithSort<*>, KArithSort<*>>(::mkArithDiv)
            ExprKind.PowerArithExpr -> deserialize<KArithSort<*>, KArithSort<*>, KArithSort<*>>(::mkArithPower)
            ExprKind.LtArithExpr -> deserialize<KBoolSort, KArithSort<*>, KArithSort<*>>(::mkArithLt)
            ExprKind.LeArithExpr -> deserialize<KBoolSort, KArithSort<*>, KArithSort<*>>(::mkArithLe)
            ExprKind.GtArithExpr -> deserialize<KBoolSort, KArithSort<*>, KArithSort<*>>(::mkArithGt)
            ExprKind.GeArithExpr -> deserialize<KBoolSort, KArithSort<*>, KArithSort<*>>(::mkArithGe)

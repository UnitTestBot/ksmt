 ...
 *
 * For all options, the current configuration value can be queried via [Native.bitwuzlaGetOption].
 * Options with string configuration values internally represent these values as enum values.
...
enum class BitwuzlaOption(val value: Int) {
     ...
     *  * **0**: disable (**default**)
     */
    BITWUZLA_OPTION_PRODUCE_MODELS(1),
     ...
     *  * **0**: disable (**default**)
     */
    BITWUZLA_OPTION_PRODUCE_UNSAT_ASSUMPTIONS(2),
     ...
     *  * **0**: disable (**default**)
     */
    BITWUZLA_OPTION_PRODUCE_UNSAT_CORES(3),
     ...
     */
    BITWUZLA_OPTION_TIME_LIMIT_PER(6),
     ...
     */
    BITWUZLA_OPTION_REWRITE_LEVEL(8),
     ...
     */
    BITWUZLA_OPTION_PROP_CONST_BITS(10),
     ...
     * **warning:** This is an expert option to configure the prop solver engine.
     */
    BITWUZLA_OPTION_PROP_INFER_INEQ_BOUNDS(11),
     ...
     * **warning:** This is an expert option to configure the prop solver engine.
     */
    BITWUZLA_OPTION_PROP_NPROPS(12),
     ...
     * **warning:** This is an expert option to configure the prop solver engine.
     */
    BITWUZLA_OPTION_PROP_NUPDATES(13),
     ...
     *
     * When enabled, substitutes contradicting nodes of kind [BitwuzlaKind.BITWUZLA_KIND_BV_AND] with zero.
     *
     * Values:
     *  * **1**: enable (**default**)
     *  * **0**: disable
